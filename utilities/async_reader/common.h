...
#include "utilities/async_reader/logging.h"
...
#define LOG(l, ...) (void)(0)
// g_pLogger->Logging("SPTAG", l, __FILE__, __LINE__, __FUNCTION__, __VA_ARGS__)
...
#include "utilities/async_reader/definition_list.h"
