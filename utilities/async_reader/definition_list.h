...
DefineVectorValueType(Int8, std::int8_t) DefineVectorValueType(
    UInt8,
    std::
        uint8_t) DefineVectorValueType(Int16,
                                       std::
                                           int16_t) DefineVectorValueType(Float,
                                                                          float)
    ...
    DefineVectorValueType2(Int8, Int8, std::int8_t,
                           std::int8_t) DefineVectorValueType2(Int8, UInt8,
                                                               std::int8_t,
                                                               std::uint8_t)
        DefineVectorValueType2(Int8, Int16, std::int8_t,
                               std::int16_t) DefineVectorValueType2(Int8, Float,
                                                                    std::int8_t,
                                                                    float)
            DefineVectorValueType2(
                UInt8, Int8, std::uint8_t,
                std::int8_t) DefineVectorValueType2(UInt8, UInt8, std::uint8_t,
                                                    std::uint8_t)
                DefineVectorValueType2(
                    UInt8, Int16, std::uint8_t,
                    std::int16_t) DefineVectorValueType2(UInt8, Float,
                                                         std::uint8_t, float)
                    DefineVectorValueType2(
                        Int16, Int8, std::int16_t,
                        std::int8_t) DefineVectorValueType2(Int16, UInt8,
                                                            std::int16_t,
                                                            std::uint8_t)
                        DefineVectorValueType2(
                            Int16, Int16, std::int16_t,
                            std::int16_t) DefineVectorValueType2(Int16, Float,
                                                                 std::int16_t,
                                                                 float)
                            DefineVectorValueType2(
                                Float, Int8, float,
                                std::
                                    int8_t) DefineVectorValueType2(Float, UInt8,
                                                                   float,
                                                                   std::uint8_t)
                                DefineVectorValueType2(Float, Int16, float,
                                                       std::int16_t)
                                    DefineVectorValueType2(Float, Float, float,
                                                           float)
                                        ...
                                        DefineDistCalcMethod(
                                            L2) DefineDistCalcMethod(Cosine)
    ...
    DefineErrorCode(Success, 0x0000) DefineErrorCode(Fail, 0x0001)
        DefineErrorCode(FailedOpenFile,
                        0x0002) DefineErrorCode(FailedCreateFile, 0x0003)
            DefineErrorCode(ParamNotFound,
                            0x0010) DefineErrorCode(FailedParseValue, 0x0011)
                DefineErrorCode(MemoryOverFlow,
                                0x0012) DefineErrorCode(LackOfInputs, 0x0013)
    ...
    DefineErrorCode(Socket_FailedResolveEndPoint, 0x4000)
        DefineErrorCode(Socket_FailedConnectToEndPoint, 0x4001)
            ...
            DefineIndexAlgo(BKT) DefineIndexAlgo(KDT) DefineIndexAlgo(SPANN)
...
// target vectors and queries
    ...
    // K of 1st vector(int32_t), 1st nn id(int32_t), SPACE, 2nd nn id, SPACE,
    // 3rd nn id,... K of 2nd vector(int32_t), 1st nn id, SPACE, 2nd nn id,
    // SPACE, 3rd nn id,...
    // ...
